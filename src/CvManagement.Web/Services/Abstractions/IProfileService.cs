...
public interface IProfileService
{
    ...
    Task AddToInfoAsync(string userId, IReadOnlyCollection<int> attributeIds, CancellationToken ct = default);
    Task RemoveFromInfoAsync(string userId, IReadOnlyCollection<int> attributeIds, CancellationToken ct = default);
}
